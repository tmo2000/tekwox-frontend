  ...
  return (
    <div>
      ...
      <div className="bg-[#c4cee9] flex flex-col items-center justify-center min-h-1/2">
        <div className="bg-[#5d6aa8] p-20 pt-36 px-[4rem] rounded-md shadow-md text-center w-[70%] mb-0">
        ...
        <div className=" p-8  text-center w-[50%]">
          <h2 className="text-[#444] text-3xl mb-4">Explore Projects Opportunities</h2>
          <form className="flex justify-between gap-4">
    ...
    <div className="flex items-center gap-4 p-4" style={{backgroundColor: "#c4cee9"}}>
            <div className="text-black font-bold text-3xl mb-12 m-4 w-1/2">Find exceptional tech <br/>talents from anywhere <br />in the world</div>
            <input
                type="text"
                placeholder="Search"
