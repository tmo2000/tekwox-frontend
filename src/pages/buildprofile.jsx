    ...
    <div>
      ...
      <div className="mt-24 flex items-center justify-between">
          ...
          (() => {
            ...
            return (
              <h2 className="font-bold text-3xl mb-12 ">
                <span>Welcome, {userData.firstname}</span><br /> Build your profile
              </h2>
            );
          })()
        ) : (
          <h2 className="font-bold text-3xl mb-12 ">Welcome, Build your profile</h2>
        )}
        <button className="border bg-[#D9D9D9] hover:bg-blue-700 font-bold py-2 px-28 rounded-full flex items-center">
          <FontAwesomeIcon icon={faLinkedin} className="mr-2" />
          LinkedIn
        </button>
        <br />
        <Link to="/personal">
          <button className="border bg-[#D9D9D9] hover:bg-blue-700 font-bold py-2 px-24 rounded-full flex items-center mt-2">
            Do it manually
          </button>
        </Link>
          
          <p className="mt-8">It will take 10 minutes</p>
        </div>
        ...
        <Link to="/jobseekerdashboard">
          <span className="absolute bottom-8 right-8 mr-4 mb-4 text-sm text-[#5D6AA8]">
