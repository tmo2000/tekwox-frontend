  ...
  return (
    <div>
      ...
      <div className="border border-1 rounded-2xl h-auto w-[70%] px-10 mt-[2rem] ml-[11rem] text-left ">
        <div className="flex justify-left font-semibold mt-8 gap-7">
          <div>Lagos, Nigeria</div>
          <div> Open to only Local Businesses</div>
          <div>Bid Limit</div>
          <div>Live Project</div>
        </div>
        <div className=" rounded-2xl h-auto w-[70%] justify-around leading-8  mt-[2rem] text-justify text-lg ">
          ...
          <div className="mt-[2rem] text-xl">
            ...
            <p>
              ...
              and pneumatic actuators, the limb will mimic the natural movements
              and flexibility of human limbs. It will consist of multiple
              segments to simulate joints and allow for a wide range of motion.
            </p>
            <p>
            ...
            <p>
              ...
              adapt to different rehabilitation exercises, customizing
              assistance levels and movement patterns based on the individual's
              needs.
            </p>
            <p>
          ...
          <div className="mt-[2rem] text-xl">
            ...
            <p>
              ...
              adaptable control systems that can learn and adjust the assistance
              levels based on user feedback and performance.
            </p>
            <p>
              3. User-Friendly Interface: Create an easy-to-use interface for
              both patients and therapists, ensuring smooth interaction and data
              monitoring.
            </p>
            <p>
              4. Safety and Comfort: Prioritize safety features to prevent
              injury during rehabilitation exercises and ensure the soft robotic
              limb's comfort during prolonged use.
            </p>
          </div>
          <div className="mt-[2rem] text-xl">
      ...
      <div className="border border-1 rounded-2xl h-auto w-[70%] px-10 mt-[2rem] ml-[11rem]">
        <h3 className="mt-8 mr-[30rem] font-bold text-xl ">
          Screening Questions
        </h3>
        <div className="border border-1 rounded-2xl w-[50%]"></div>
      </div>
    </div>
  );
};
